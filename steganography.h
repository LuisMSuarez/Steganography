...
namespace steganographyLib
{
    class Steganography
    {
        public:
            ...
            void embedInformation(const std::string &originalBitmapFilePath, const std::string &sourceDataFilePath, const std::string &destinationBitmapDataFilePath, u_int8_t bitsPerPixel);
            ...
            void extractInformation(const std::string &sourceBitmapFilePath, const std::string &destinationDataFilePath, u_int8_t bitsPerPixel);
        private:
    };
}